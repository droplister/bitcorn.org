...
<div class="row xs-mb-60">
    <div class="col-md-6 xs-about-feature">
        <h3>How to Vote</h3>
        <p>Cast your vote by sending {{ $election->asset->display_name }} to <a href="https://xcpfox.com/address/{{ config('bitcorn.ballot_address') }}">{{ config('bitcorn.ballot_address') }}</a>, using the candidate's vote code as the memo.</p>
    </div>
    <div class="col-md-6 xs-about-feature">
        <h3>How it Works</h3>
