...
class MerchGlassesCommand extends Command
{
    /**
     ...
     */
    protected $description = 'Glasses Merch Command';
    ...
    public function handle($arguments)
    {
        ...
        if($this->isBitcornChat($chat_id) &&
           ...
           $this->isValidAddress($address)) {
            // Send Merch
            SendMerchJob::dispatch($chat_id, $address, $item_no, 'A1976569558204240008');
        }
    }
